...
class l1_deframer(gwnblock_py):
    '''New GWN block in Python, created from template.

    '''
    def __init__(self, out_type='event'):
      gwnblock_py.__init__(self, name='l1_deframer', number_in=0, number_out=1, number_timers=0, number_timeouts=0)
