...
class packet_tx_gwn(gr.hier_block2):
    ...
    def __init__(self, eb=None, hdr_const=None, hdr_enc=None, hdr_format=None,
        ...
        self.blocks_pdu_to_tagged_stream_0_0 = blocks.pdu_to_tagged_stream(types.byte_t, 'packet_len')
        self.blocks_pdu_to_tagged_stream_0 = blocks.pdu_to_tagged_stream(types.byte_t, 'packet_len')
