...
class pasador2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "pasador2")
        ...
        # Blocks
        ##################################################
        self.gwn3_msg_source_0 = gwn3.msg_source(10,1,'El Mensaje')
...
def main(top_block_cls=pasador2, options=None):
